...
namespace Linq.LinqMethods
{
    ...
    {
        private const string AfterFirstOrDefaultStr = "The list after the 'FirstOrDefault' method is applied. Will return the first element in the list. If no element is found it will return null.";
